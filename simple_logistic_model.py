...
def cross_validation_model(sequence_pam_per_gene_grna, count_insertions_gene_grna, count_deletions_gene_grna):
  fold_valid = KFold(n_splits = 3, shuffle = True, random_state = 1)
  ...
  print "Average accuracy for insertions predictions is %f" % insertion_avg_accuracy
  print "Average accuracy for deletions predictions is %f" % deletion_avg_accuracy
